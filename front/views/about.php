                ...
                <div class="container">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-8 d-flex align-items-center flex-column flex-lg-row">
                            ...
                            <p class="header-text">EEEEEEEEEE <span>“Watches2019”</span></p>
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb justify-content-center">
                            ...
                            <li class="current"><a href="shop.html">A propos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-10 offset-1">
                                    <div class="about-text text-center">
                                        ...
                                        <p class="mb--40 mb-sm--30">écrivez ici qq chose à propos de ous</p>
                                        <div class="about-btn-group text-center">
                                            <a href="portfolio.html" class="btn btn-style-3">voir le travail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
