...
include "../core/crudwish.php";

$wish=new Crudwish();
$wish1=$wish->recupererWish();
...
<!-- Mirrored from demo.devitems.com/mirora-v2/mirora/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:53:11 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="wishlist-area pt--40 pb--80 pt-md--30 pb-md--60">
                <div class="container">
                    ...
                    <div class="wishlist-wrapper bg--2">
                        <div class="row">
                            <div class="col-12">
                                <form action="wishadd.php" class="form form--cart">
                                    <div class="wishlist-table table-content table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                               ...
                                               <?php
                                                      foreach ($wish1 as $key )
                                              
                                                {
                                                    ?>
                                                    <tr>
                                                    <td><a class="delete" href="wish.php?delete=<?php echo $key['id']; ?>"><i class="fa fa-times"></i></a></td>
                                                    <td>
                                                        <a href="product-details.html">
                                                            <img src="<?php echo $key['img']; ?>"alt="product">
                                                        </a>
                                                    </td>
                                                    <td><h3><a href="product-details.html"><?PHP echo $key['nom']; ?></a></h3></td>
                                                    <td class="cart-product-price"><strong><?PHP echo $key['prix']; ?></strong></td>
                                                   
                                                    <td><a href="cart.html" class="btn add-to-cart btn-medium btn-style-2">Acheter </a></td>
                                                </tr>
                                            }
                                        <?php } ?>
