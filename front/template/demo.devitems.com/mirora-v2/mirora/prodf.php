...
<!-- Mirrored from demo.devitems.com/mirora-v2/mirora/shop-list-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:53:53 GMT -->
<head>
    <meta charset="utf-8">
...
<table>
        <tbody>
            ...
            foreach ($result as $key ) {
                if ($key['categorie']=='Femme')
                {
                ?>
                <form method="POST" action="product-details.php">
                <tr>
                    <div class="mirora-product-list" style="margin-left: 500px;">
                ...
                <div class="caption">
                    <br>
                  <h3><a class="defaultBtn" type="submit" href="product-details.php">VIEW</a> <span class="pull-right"><?php echo $key['prix'];?>dt</span> <span class="pull-left"><?php echo $key['nom'];?></span></h3>
