...
<body>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($liste as $element)
                                        {
                                            ...
                                            <tr role="row" <?php echo (($i%2)==0)?'class="odd"':'class="even"'; ?> >
                                                ...
                                                <td>
                                                    <button type="button" onclick="document.location='modifier-commande.php?n='+<?php echo htmlspecialchars($element['numero']); ?>+'&e='+<?php echo $element['etat']; ?>" class="btn btn-success"><i class="fa fa-magic"></i>  Modifier état</button>
                                                    <button type="button" onclick="document.location='supprimer-commande.php?n='+<?php echo htmlspecialchars($element['numero']); ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i>  Supprimer</button>
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
	...
	backDown();
	?>
    <script type="text/javascript" src="assets/js/afficher-commande.js"></script>
