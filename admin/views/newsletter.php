                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"> Envoyer une newsletter </strong>
                            </div>
                            <div class="card-body">
                                <form method="post" action="../../front/views/mail.php" id="ajoutn">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="titre" class=" form-control-label">Titre newsletter</label></div>
                            ...
                            <div class="card-footer">
                                <button type="submit" form="ajoutn" class="btn btn-primary btn-sm">
