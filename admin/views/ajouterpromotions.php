...
if (isset($_POST['nom']) and isset($_POST['idproduit']) and isset($_POST['description']) and isset($_POST['datedebut']) and isset($_POST['datefin'])and isset($_POST['pourcentage'])){
$promotions1=new promotions($_POST['nom'],$_POST['idproduit'],$_POST['description'],$_POST['datedebut'],$_POST['datefin'],$_POST['pourcentage']);

$promotions1C=new promotionsC();
$promotions1C->ajouterpromotions($promotions1);
